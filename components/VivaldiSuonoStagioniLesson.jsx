    ...
    keywords: [
      {
        ...
        longitude: -56,
        copy:
          "Il Seicento e un secolo di opposizioni fortissime: guerra e ricchezza, fede e scienza, splendore delle corti e miseria del popolo. Il Barocco nasce dentro questa tensione. Per questo la sua arte e la sua musica cercano movimento, dramma, effetti intensi e cambi improvvisi.",
      },
      {
        id: "storico-guerra",
        title: "Guerra",
        ...
        longitude: -26,
        copy:
          "La Guerra dei Trent'anni e una delle grandi ferite del Seicento europeo. E una guerra politica e religiosa che mostra quanto l'Europa sia instabile. Questa tensione storica aiuta a capire perche il Barocco ami il contrasto, il pathos e la rappresentazione drammatica della realta.",
      },
      {
        id: "storico-scienza",
        title: "Scienza",
        ...
        longitude: 2,
        copy:
          "Nel Seicento si sviluppa la moderna ricerca scientifica, con Galileo Galilei come figura centrale. Mentre l'arte cerca stupore e meraviglia, la scienza introduce un nuovo modo di osservare il mondo: esperienza, misura, verifica.",
      },
      {
        ...
        longitude: 28,
        copy:
          "L'Italia del Seicento non e unita: e frammentata, sottoposta a dominazioni straniere e colpita da peste e carestie. Eppure conserva un ruolo musicale decisivo. Venezia, Napoli e Roma sono tra i centri piu vivi del Barocco europeo.",
      },
    ],
  },
  {
    ...
    summary:
      "La societa barocca e fortemente gerarchica. La corte e la Chiesa sono luoghi centrali della vita pubblica e musicale. La musica accompagna cerimonie, feste, riti, celebrazioni e momenti ufficiali. Nel Barocco la musica non e solo intrattenimento: e anche rappresentazione del potere.",
    mustKnow: [
    ...
    keywords: [
      {
        ...
        longitude: 66,
        copy:
          "La corte e uno dei luoghi simbolici del Barocco. Re, principi e nobili vivono circondati da cerimonie, feste, ricevimenti e musica. La giornata del sovrano puo essere accompagnata da musicisti in momenti pubblici e privati. La musica diventa parte dello spettacolo del potere.",
      },
      {
        id: "sociale-potere",
        title: "Potere",
        ...
        longitude: 94,
        copy:
          "Nel Barocco arte e musica servono spesso a celebrare sovrani, principi e autorita religiose. Lo splendore non e casuale: deve impressionare, convincere, mostrare grandezza. La grandiosita sonora e visiva diventa un linguaggio politico e simbolico.",
      },
      {
        id: "sociale-chiesa",
        title: "Chiesa",
        ...
        longitude: 122,
        copy:
          "La Chiesa e uno dei grandi centri della musica barocca. La musica sacra assume toni solenni e grandiosi: inni, oratori, messe e composizioni liturgiche servono a rendere piu intensa l'esperienza religiosa e a celebrare la grandezza del sacro.",
      },
      {
        ...
        longitude: 150,
        copy:
          "La societa del Seicento e fortemente diseguale: la nobilta vive nel lusso delle corti, mentre gran parte del popolo vive in condizioni difficili. Il Barocco va letto anche come arte dell'apparenza: uno splendore che spesso copre crisi, poverta e tensioni sociali.",
      },
    ],
  },
  {
    ...
    summary:
      "Il Barocco vuole colpire chi guarda e chi ascolta. Cerca meraviglia, emozione, teatralita, movimento e ornamento. Lo stile barocco non punta alla semplicita: vuole stupire, coinvolgere e commuovere attraverso effetti forti, contrasti, abbellimenti e grandiosita.",
    mustKnow: [
    ...
    keywords: [
      {
        ...
        longitude: 176,
        copy:
          "Il Barocco vuole provocare meraviglia. L'opera d'arte deve sorprendere, catturare lo sguardo e coinvolgere chi osserva o ascolta. Anche la musica segue questa direzione: cerca effetti sonori, contrasti, cambi d'intensita e momenti capaci di restare impressi.",
      },
      {
        ...
        longitude: 204,
        copy:
          "Nel Barocco tutto tende a diventare spettacolo: feste di corte, cerimonie religiose, teatro, musica all'aperto, celebrazioni pubbliche. La musica non e isolata: entra in un sistema fatto di spazi, gesti, immagini, scenografie e rituali collettivi.",
      },
      {
        ...
        longitude: 232,
        copy:
          "L'ornamento e un tratto fondamentale del gusto barocco. Come le chiese si riempiono di stucchi e dorature, anche la musica si arricchisce di abbellimenti, passaggi rapidi, variazioni e fioriture. L'ornamento rende il discorso piu brillante ed espressivo.",
      },
      {
        ...
        longitude: 258,
        copy:
          "Il Barocco non vuole lasciare indifferenti. Pittura, scultura, teatro e musica cercano di commuovere, agitare, stupire. La musica usa melodie marcate, timbri riconoscibili, tensioni e cambi improvvisi per parlare direttamente all'ascoltatore.",
      },
    ],
  },
  {
    ...
    summary:
      "Nel Barocco la musica cambia profondamente. Nasce il melodramma, si affermano il basso continuo, la monodia accompagnata, la teoria degli affetti, il concerto grosso e il concerto solista. Cresce il ruolo degli strumenti, soprattutto archi, violino e clavicembalo. Vivaldi nasce dentro questo mondo: teatro, contrasto, emozione e dialogo strumentale.",
    mustKnow: [
    ...
    keywords: [
      {
        ...
        longitude: 286,
        copy:
          "Nel Barocco nasce il melodramma, cioe l'opera. Musica, recitazione e scenografia si fondono in un unico grande evento teatrale. La musica non accompagna soltanto una storia: costruisce personaggi, emozioni, tensioni e colpi di scena.",
      },
      {
        ...
        longitude: 310,
        copy:
          "Il basso continuo e una tecnica fondamentale del Barocco. Una linea grave e una serie di accordi sostengono il canto o la melodia. Di solito il clavicembalo realizza gli accordi, mentre strumenti gravi come violoncello, viola da gamba o fagotto rinforzano il basso.",
      },
      {
        id: "musicale-affetti",
        title: "Affetti",
        ...
        longitude: 334,
        copy:
          "La teoria degli affetti parte da un'idea chiara: la musica deve suscitare sentimenti riconoscibili. Timbri, tonalita, melodie, ritmo e intensita vengono usati per evocare gioia, dolore, tensione, solennita, agitazione o tenerezza.",
      },
      {
        ...
        longitude: 358,
        copy:
          "La musica barocca usa spesso contrasti sonori: piano e forte, solo e tutti, chiaro e scuro, calma e agitazione. Questi contrasti creano movimento, sorpresa e dramma. Nei concerti di Vivaldi saranno fondamentali per far sentire dialogo, energia e paesaggio.",
      },
      {
        ...
        longitude: 20,
        copy:
          "Nel Barocco la musica strumentale acquista nuova importanza. Gli strumenti vengono perfezionati o trasformati; iniziano a formarsi orchestre stabili; violino e clavicembalo diventano strumenti centrali. Gli archi sono particolarmente adatti a esprimere movimento, tensione e sfumature emotive.",
      },
      {
        ...
        longitude: 44,
        copy:
          "Il concerto nasce in Italia alla fine del Seicento e si diffonde in Europa. Puo essere concerto grosso, con un piccolo gruppo di solisti contrapposto all'orchestra, oppure concerto solista, con uno strumento protagonista che dialoga con il gruppo. E la forma che portera direttamente a Vivaldi.",
      },
      {
        ...
        longitude: 68,
        copy:
          "Nel Barocco l'Italia e una guida musicale europea. Venezia, Napoli e Roma sono citta decisive. Da qui si diffondono modelli importanti: melodramma, concerto, stile concertato, musica sacra solenne e una nuova centralita degli strumenti.",
      },
    ],
  },
];
    ...
    <button
      ...
      style={{
        ...
        zIndex: isKeywordActive
          ? 80
          : isOrbitActive
            ? Math.round(34 + item.depth * 38)
            : Math.round(10 + item.depth * 18),
      }}
      ...
      if (!dragRef.current.active && !prefersReducedMotion) {
        const nextX = clamp(
          rotationRef.current.x +
            ...
            (targetRotation.x - rotationRef.current.x) * 0.048,
          deg(-34),
          deg(34),
        );
        const nextY = normalizeAngle(
          rotationRef.current.y +
            ...
            shortestAngleDifference(rotationRef.current.y, targetRotation.y) * 0.042 +
            0.00008,
        );
      ...
      .map((item) => {
        ...
        return {
          ...
          displayScale:
            ...
            (isKeywordActive ? 1.16 : isOrbitActive ? 1.02 : 0.78),
          displayOpacity: clamp(
            projectedPoint.opacity * (isOrbitActive ? 0.98 : 0.46) +
              (isKeywordActive ? 0.14 : 0),
        ...
        <div className="lesson-shell vivaldi-context-block__shell">
          ...
          <div className="vivaldi-context-stage">
            <div className="vivaldi-globe-stage">
              <div className="vivaldi-globe-layout">
                <div className="vivaldi-globe-scene">
                  <div className="vivaldi-globe-stage__topline">
                    <p>Seleziona un'orbita</p>
                    <span>trascina la sfera o attiva una parola chiave</span>
                  </div>

                  <div className="vivaldi-orbit-selector">
                ...
                >
                  <div className="vivaldi-globe-detail-panel__meta">
                    <p className="vivaldi-globe-popup__eyebrow">
                      {panelMode === "keyword" ? activeOrbit.title : "Orbita selezionata"}
                    </p>
                    <span>
                      {panelMode === "keyword"
                        ? "Parola chiave"
