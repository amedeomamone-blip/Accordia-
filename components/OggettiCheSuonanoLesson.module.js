// components/OggettiCheSuonanoLesson.jsx
...
var lesson = {
  ...
  subtitle: "Pietra, osso, legno, semi, pelle e canne non sono ancora musica da soli. Diventano risorse sonore quando qualcuno li usa con un gesto riconoscibile e per una funzione chiara.",
  breadcrumbs: [
  ...
  opening: {
    ...
    intro: "Ogni oggetto suggerisce un gesto: battere, scuotere, sfregare, soffiare. Il materiale non dice tutto, ma orienta gia il tipo di suono che ti aspetti.",
    ...
    side: {
      ...
      caption: "Un oggetto forato non e automaticamente uno strumento, ma ci costringe a chiederci quale gesto, quale suono e quale funzione potesse avere."
    }
  },
  exploration: {
    title: "Dal materiale al suono riconoscibile",
    intro: "Le fonti scolastiche sulle musiche antiche ricordano flauti, tamburi, arpe, trombe e cimbali. Dietro queste forme piu stabili c'e un passaggio piu semplice: alcuni materiali vengono scelti perche rispondono bene a un gesto.",
    layout: "essay-side",
    cardsPosition: "after",
    side: {
      type: "terms",
  ...
  active: {
    ...
    intro: "Qui la comprensione attiva diventa davvero laboratoriale: prendi esempi diversi, li ordini con parole precise e provi a spiegare perche alcuni oggetti sono gia vicini a uno strumento.",
  ...
  followupIntro: "Questa lezione sta in mezzo tra concetto e manipolazione: chiarisci il vocabolario, poi lo usi per ordinare esempi, costruire tavole e spiegare bene i passaggi.",
...
function OggettiCheSuonanoLesson() {
  return /* @__PURE__ */ React3.createElement(OriginiTopicLesson, { lesson });
}
export {
  OggettiCheSuonanoLesson as default
};
