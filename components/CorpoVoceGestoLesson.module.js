    ...
    return /* @__PURE__ */ React.createElement(
      "button",
      {
        ...
        className: cn(
          ...
          isActive ? "border-[#c66a18] bg-[#fff1e2] text-[#8a4d18]" : "border-slate-200 bg-[#f5f3ee] text-slate-600 hover:border-slate-300 hover:bg-[#ece8df]"
        ),
...
function LessonProductPage() {
  return /* @__PURE__ */ React.createElement("div", { style: { fontFamily: APP_FONT }, className: "accordia-lesson-page bg-[#fbfaf7] text-slate-950 antialiased" }, /* @__PURE__ */ React.createElement(LessonHero, null), /* @__PURE__ */ React.createElement(ListeningTimerSection, null), /* @__PURE__ */ React.createElement(OriginStorySection, null), /* @__PURE__ */ React.createElement(BodyInstrumentSection, null), /* @__PURE__ */ React.createElement(ConceptBoardSection, null), /* @__PURE__ */ React.createElement(BodyPercussionSequencer, null), /* @__PURE__ */ React.createElement(GraphicScoreBuilder, null), /* @__PURE__ */ React.createElement(FinalQuiz, null));
}
