...
function ConceptVisual({ type }) {
  if (type === "group-2" || type === "group-3" || type === "group-4") {
    ...
    const groupStyle = type === "group-2" ? {
      ...
      accent: "h-11 w-11 border-[#c8dbc9] bg-[radial-gradient(circle_at_35%_35%,#ffffff_0%,#e4f0e6_100%)] text-[#45634f] shadow-[0_10px_22px_rgba(95,129,104,0.12)]"
    } : type === "group-3" ? {
      ...
      accent: "h-11 w-11 border-[#e7cdb9] bg-[radial-gradient(circle_at_35%_35%,#fffdfb_0%,#fee9d7_100%)] text-[#8a4d18] shadow-[0_10px_22px_rgba(198,106,24,0.14)]"
    } : {
      ...
      accent: "h-11 w-11 border-[#c8d7ea] bg-[radial-gradient(circle_at_35%_35%,#ffffff_0%,#e2ebf8_100%)] text-[#3e5f86] shadow-[0_10px_22px_rgba(62,95,134,0.13)]"
    };
    return /* @__PURE__ */ React.createElement("div", { className: cn("flex items-center gap-3 rounded-full border px-3 py-2", groupStyle.wrap) }, /* @__PURE__ */ React.createElement("span", { className: cn("text-[0.72rem] font-semibold uppercase tracking-[0.18em]", groupStyle.label) }, "a ", size), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2" }, Array.from({ length: size }).map((_, index) => /* @__PURE__ */ React.createElement(
      "span",
      {
        key: `${type}-${index}`,
        className: cn(
      ...
      return /* @__PURE__ */ React.createElement("div", { key: `${groupSize}-${index}`, className: "flex flex-col items-center gap-2" }, /* @__PURE__ */ React.createElement(
        "span",
        {
          className: cn(
            ...
            accented ? "h-14 w-14 border-[#e7cdb9] bg-[radial-gradient(circle_at_35%_35%,#fffdfb_0%,#fee8d6_100%)] text-[#8a4d18]" : "h-10 w-10 border-[#d7e1ec] bg-[radial-gradient(circle_at_35%_35%,#ffffff_0%,#edf3fa_100%)] text-[#647791]"
          )
        },
        accented ? "\u25CF" : "\u2022"
    ...
    return /* @__PURE__ */ React.createElement("div", { key: `${groupSize}-${index}`, className: "flex flex-col items-center gap-3" }, /* @__PURE__ */ React.createElement(
      "span",
      {
        className: cn(
          ...
          accented ? "h-16 w-16 border-[#e7cdb9] bg-[radial-gradient(circle_at_35%_35%,#fffdfb_0%,#fee8d6_100%)] text-[#8a4d18]" : "h-12 w-12 border-[#d7e1ec] bg-[radial-gradient(circle_at_35%_35%,#ffffff_0%,#edf3fa_100%)] text-[#647791]"
        )
      },
      accented ? "\u25CF" : "\u2022"
