...
function MeterPreview({ groupSize }) {
  return /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex flex-wrap justify-center gap-3" }, Array.from({ length: 8 }).map((_, index) => {
...
function LessonHero() {
  ...
  return /* @__PURE__ */ React.createElement("section", { id: section.id, className: "lesson-hero scroll-mt-28", style: { fontFamily: APP_FONT } }, /* @__PURE__ */ React.createElement("div", { className: "lesson-hero-stage" }, /* @__PURE__ */ React.createElement("div", { className: "lesson-hero-grid" }, /* @__PURE__ */ React.createElement("div", { className: "lesson-hero-copy max-w-[48rem]" }, /* @__PURE__ */ React.createElement(SectionKicker, null, section.eyebrow), /* @__PURE__ */ React.createElement("h1", { className: "lesson-hero-title mt-6 max-w-[9ch] text-[3.9rem] font-semibold tracking-[-0.065em] text-slate-950 sm:text-[5rem] lg:text-[6rem] lg:leading-[0.9]" }, section.title)), /* @__PURE__ */ React.createElement("div", { className: "lesson-hero-panel max-w-[30rem] xl:justify-self-end xl:pb-2" }, /* @__PURE__ */ React.createElement("p", { className: "lesson-hero-lead text-[1.18rem] leading-[1.65] text-slate-600 sm:text-[1.4rem]" }, section.subtitle), /* @__PURE__ */ React.createElement("p", { className: "lesson-hero-support max-w-[43rem] text-[0.98rem] leading-7 text-slate-500 sm:text-base" }, section.microtext), /* @__PURE__ */ React.createElement("div", { className: "lesson-hero-rhythm", "aria-hidden": "true" }, /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null), /* @__PURE__ */ React.createElement("span", null))))));
}
...
function ConceptsSection() {
  ...
  return /* @__PURE__ */ React.createElement(SectionShell, { id: section.id, backgroundClass: "bg-[#fbfbf9]", className: SECTION_SPACE }, /* @__PURE__ */ React.createElement("div", { className: LESSON_SHELL, style: { fontFamily: APP_FONT } }, /* @__PURE__ */ React.createElement(SectionHeading, { kicker: "Quattro concetti", title: section.title, text: section.text, align: "center" }), /* @__PURE__ */ React.createElement("div", { className: "mt-14 grid gap-4 md:grid-cols-4" }, lessonData.conceptCards.map((card, index) => /* @__PURE__ */ React.createElement(SurfacePanel, { key: card.id, tone: "subtle", className: "p-5 sm:p-7" }, /* @__PURE__ */ React.createElement("p", { className: SMALL_LABEL }, "0", index + 1), /* @__PURE__ */ React.createElement("h3", { className: "mt-4 text-2xl font-semibold tracking-[-0.04em] text-slate-950" }, card.title), /* @__PURE__ */ React.createElement("p", { className: cn("mt-4", BODY_COPY_SOFT) }, card.definition), /* @__PURE__ */ React.createElement("div", { className: "mt-8 flex flex-wrap items-center justify-center gap-3" }, card.visual.map((item, itemIndex) => /* @__PURE__ */ React.createElement(ConceptVisual, { key: `${card.id}-${itemIndex}`, type: item })))))), /* @__PURE__ */ React.createElement(SurfacePanel, { tone: "soft", className: "mt-10 px-6 py-7 text-center" }, /* @__PURE__ */ React.createElement("p", { className: "mx-auto max-w-3xl text-[2rem] font-semibold tracking-[-0.04em] text-slate-950 sm:text-[2.4rem]" }, section.closing))));
}
...
function ListeningCardsSection() {
  ...
  return /* @__PURE__ */ React.createElement(SectionShell, { id: section.id, backgroundClass: "bg-white", className: SECTION_SPACE }, /* @__PURE__ */ React.createElement("div", { className: LESSON_SHELL, style: { fontFamily: APP_FONT } }, /* @__PURE__ */ React.createElement(SectionHeading, { kicker: "Ascolto guidato", title: section.title, text: section.text }), /* @__PURE__ */ React.createElement("div", { className: "mt-14 grid gap-6 lg:grid-cols-3" }, lessonData.listeningCards.map((card) => {
    const selectedMeter = selectedMeters[card.id] || card.expected;
    return /* @__PURE__ */ React.createElement(SurfacePanel, { key: card.id, tone: "soft", className: "p-6 sm:p-7" }, /* @__PURE__ */ React.createElement("p", { className: SMALL_LABEL }, card.focus), /* @__PURE__ */ React.createElement("h3", { className: "mt-4 text-2xl font-semibold tracking-[-0.04em] text-slate-950" }, card.title), /* @__PURE__ */ React.createElement("div", { className: "mt-6 rounded-[1.6rem] border border-slate-200/70 bg-white px-5 py-6 text-center" }, /* @__PURE__ */ React.createElement("p", { className: "text-base leading-7 text-slate-500" }, "Placeholder di ascolto guidato."), /* @__PURE__ */ React.createElement(MeterPreview, { groupSize: selectedMeter })), /* @__PURE__ */ React.createElement("div", { className: "mt-6 flex flex-wrap gap-3" }, [2, 3, 4].map((meter) => /* @__PURE__ */ React.createElement(
      "button",
      {
        key: `${card.id}-${meter}`,
        type: "button",
      ...
      meter,
      " pulsazioni"
    ))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 space-y-4" }, lessonData.listeningQuestions.map((question) => /* @__PURE__ */ React.createElement("p", { key: `${card.id}-${question}`, className: BODY_COPY_SOFT }, question))), /* @__PURE__ */ React.createElement("div", { className: "mt-6 border-t border-slate-200/70 pt-5" }, /* @__PURE__ */ React.createElement("p", { className: BODY_COPY_SOFT }, "Osserva se l'accento torna ogni due, tre o quattro battiti.")));
  }))));
}
