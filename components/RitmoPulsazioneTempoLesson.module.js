...
function RhythmSequencerSection() {
  ...
  const renderStepButton = (step, index) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "mt-4 flex flex-1 flex-col items-center justify-center text-center" }, /* @__PURE__ */ React.createElement(SequencerSymbol, { stateId: step, className: isAccent ? "text-[2.3rem] text-[#8a4d18]" : "text-[2rem]" }), /* @__PURE__ */ React.createElement("span", { className: cn("mt-3 text-[0.84rem] font-medium leading-5", isAccent ? "text-[#8a4d18]" : "text-slate-500") }, option.longLabel))
    );
  };
