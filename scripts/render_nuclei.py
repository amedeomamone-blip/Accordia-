...
ORIGINI_TOPIC_MAP["nodes"] = [
    ...
    },
    {
        ...
        "x": 18,
        "y": 68,
        "summary": "Corpo, voce, pausa e gesto diventano musica quando il gruppo li organizza in una forma chiara.",
        "phases": {
            "scintilla": {
                "title": "Come fa un gesto a diventare musica senza strumenti?",
                "body": "La domanda iniziale porta subito verso corpo, voce, pausa e intenzione del gesto.",
            },
            "rotta": {
                "title": "Prima degli strumenti, il corpo",
                "body": "Il contesto ricorda che il corpo e il primo spazio sonoro sempre disponibile al gruppo.",
            },
            "orecchio": {
                "title": "Ascoltare suoni del corpo e della voce",
                "body": "L'ascolto guidato mette a fuoco attacco, pausa, finale e riconoscibilita dei gesti sonori.",
            },
            "grafo": {
                "title": "Gesto, voce, pausa, finale",
                "body": "Organizza visivamente cio che rende leggibile una piccola frase sonora.",
            },
            "cantiere": {
                "title": "Costruire una frase sonora di 8 tempi",
                "body": "Gli studenti scelgono pochi suoni e li organizzano in una forma che il gruppo sa ripetere.",
            },
            "varco": {
                "title": "Scrivere una sequenza leggibile",
                "body": "Il compito chiede di fissare il gesto con segni semplici e leggibili da altri.",
            },
            "ribalta": {
                "title": "Provare e correggere insieme",
                "body": "La restituzione finale verifica se un altro gruppo capisce ed esegue la sequenza.",
            },
            "specchio": {
                "title": "Valutare chiarezza e controllo",
                "body": "La fase finale controlla se sai spiegare che cosa fanno pausa, voce e gesto dentro la sequenza.",
            },
        },
        "lesson": {
            "panel_only": True,
            ...
            "immersive_module": "../../../../components/CorpoVoceGestoLesson.module.js",
            "author": "Lezione di Amedeo Mamone",
            "description": "Ascolti, scegli, ripeti, fai una pausa e trasformi il gesto in una frase sonora che il gruppo riconosce.",
        },
    },
    {
        "number": "04",
